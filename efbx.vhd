...
-- Module  Version: 1.1
--/usr/local/diamond/2.2/ispfpga/bin/lin/scuba -w -n efbx -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 50 -i2c1 -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_we -i2c1_addr 7 -i2c2 -i2c2_freq 100 -i2c2_sa 1000010 -i2c2_we -i2c2_addr 7 -spi -spi_mode Slave -spi_rxo -spi_rxr -spi_txo -spi_txr -spi_en -spi_we -tc -tc_mode CTCM -tc_o TOGGLE -tc_div 1 -tc_top 65535 -tc_ocr 32767 -tc_opcomp -tc_ipcap -tc_oflow -tc_osc -tc_ctr -pll1 -pll2 -ufm -ufm_ebr 0 -mem_size 2046 -ufm_0 -wb -dev 7000 -e 
...
begin
    ...
    EFBInst_0: EFB
        ...
        UFM_INIT_PAGES=>  2046, DEV_DENSITY=> "7000L", EFB_UFM=> "ENABLED", 
        TC_ICAPTURE=> "DISABLED", TC_OVERFLOW=> "DISABLED", TC_ICR_INT=> "ON", 
        TC_OCR_INT=> "ON", TC_OV_INT=> "ON", TC_TOP_SEL=> "ON", 
        TC_RESETN=> "ENABLED", TC_OC_MODE=> "TOGGLE", TC_OCR_SET=>  32767, 
        TC_TOP_SET=>  65535, GSR=> "ENABLED", TC_CCLK_SEL=>  1, TC_MODE=> "CTCM", 
        TC_SCLK_SEL=> "POSC", EFB_TC_PORTMODE=> "WB", EFB_TC=> "ENABLED", 
        SPI_WAKEUP=> "ENABLED", SPI_INTR_RXOVR=> "ENABLED", 
        SPI_INTR_TXOVR=> "ENABLED", SPI_INTR_RXRDY=> "ENABLED", 
        ...
        EFB_SPI=> "ENABLED", I2C2_WAKEUP=> "ENABLED", I2C2_GEN_CALL=> "DISABLED", 
        I2C2_CLK_DIVIDER=>  125, I2C2_BUS_PERF=> "100kHz", 
        I2C2_SLAVE_ADDR=> "0b1000010", I2C2_ADDRESSING=> "7BIT", 
        EFB_I2C2=> "ENABLED", I2C1_WAKEUP=> "ENABLED", I2C1_GEN_CALL=> "DISABLED", 
        I2C1_CLK_DIVIDER=>  32, I2C1_BUS_PERF=> "400kHz", 
        I2C1_SLAVE_ADDR=> "0b1000001", I2C1_ADDRESSING=> "7BIT", 
        EFB_I2C1=> "ENABLED", EFB_WB_CLK_FREQ=> "50.0")
        port map (WBCLKI=>wb_clk_i, WBRSTI=>wb_rst_i, WBCYCI=>wb_cyc_i, 
            ...
            I2C1SDAOEN=>i2c1_sdaoen, I2C2SCLO=>i2c2_sclo, 
            I2C2SCLOEN=>i2c2_scloen, I2C2SDAO=>i2c2_sdao, 
            I2C2SDAOEN=>i2c2_sdaoen, I2C1IRQO=>i2c1_irqo, 
            I2C2IRQO=>i2c2_irqo, SPISCKO=>spi_clk_o, 
            ...
            WBCUFMIRQ=>wbc_ufm_irq, CFGWAKE=>cfg_wake, 
            CFGSTDBY=>cfg_stdby);
