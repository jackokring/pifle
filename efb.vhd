...
-- Module  Version: 1.1
--/usr/local/diamond/2.2/ispfpga/bin/lin/scuba -w -n efb -lang vhdl -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 50 -i2c1 -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_we -i2c1_addr 7 -i2c2 -i2c2_freq 100 -i2c2_sa 1000010 -i2c2_we -i2c2_addr 7 -spi -spi_mode Slave -spi_rxr -spi_txr -spi_en -spi_we -tc -tc_mode CTCM -tc_o WAVE_GENERATOR -tc_div 1 -tc_top 65535 -tc_ocr 32767 -tc_osc -tc_ctr -pll1 -pll2 -ufm -ufm_ebr 0 -mem_size 2046 -ufm_0 -wb -dev 7000 -e 

-- Tue Dec  3 19:47:49 2013
