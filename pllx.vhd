...
-- Module  Version: 5.4
--/usr/local/diamond/2.2/ispfpga/bin/lin/scuba -w -n pllx -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 100 -fclkop 25 -fclkop_tol 5.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock -wb -fracn 0 -e 
...
entity pllx is
 ...
 attribute dont_touch of pllx : entity is true;
end pllx;

architecture Structure of pllx is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  21, CLKFB_DIV=>  1, CLKI_DIV=>  4, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pllx is
    for Structure
